...
package com.android.beez.loadimage;
...
import com.android.beez.BuildConfig;
...
public abstract class ImageWorker {
		...
		if (value != null) {
			...
			if (cancelPotentialWork(data, imageView)) {
				if (this.imageWorkerEventListener != null){
					final BitmapWorkerTask task = new BitmapWorkerTask(imageView, (String) data, this.imageWorkerEventListener);
	...
	private class BitmapWorkerTask extends
		...
		public BitmapWorkerTask(ImageView imageView, String path, ImageWorkerEventListener imageWorkerEventListener) {
			imageViewReference = new WeakReference<ImageView>(imageView);
