...
public class JSON2Object {
	...
	public Object parse() {
		try {
			...
			while (i.hasNext()) {
				...
				String methodName = "";
				for (String s : chars) {
					methodName += s.substring(0, 1).toUpperCase()
							+ s.substring(1);
				}
				...
				try {
					...
					if (fieldValue != null
							&& !"null".equals(fieldValue.toString())) {
					...
					Log.d("JSON2Object", field == null ? "" : field.getName()
							+ ": " + e.getMessage(), e);
					Log.d("JSON2Object", ": "+json.toString());
	...
	public static Object getObjectFromJSON(JSONObject JSON,
			@SuppressWarnings("rawtypes") Class C) throws Throwable {
